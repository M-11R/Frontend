...
const PJDelBtn = ({pid}: {pid: number}) => {
    ...
    return (
        <div style={{width: '70%', margin: '5% auto', marginBottom: '0', display: 'flex', flexDirection: 'column'}}>
            <span style={{fontSize: '40px'}}>프로젝트 삭제</span>
            <div style={{width: '100%', border: '1px solid #000', whiteSpace: "pre-wrap", margin: '5px', padding: '15px'}}>
                <span>{`프로젝트를 삭제하시겠습니까?\n삭제할려면 "`}</span>
            ...
            <div style={{display: 'flex'}}>
                ...
                <button
                        ...
                        style={{width: '50px', padding: '10px', margin: '5px', border: 'none', cursor: 'pointer', color: '#ffffff', backgroundColor: '#FF4D4D'}}
                >삭제</button>
            </div>
        </div>
    )
